...
Т.к. префикс /64, сетевая часть занимает четыре первых «хекстета»/блока по 16 бит - 2001:db8:acad:0. Значит идентификатор подсети в индивидуальном IPv6-адресе 2001:db8:acad::aaaa:1234/64 будет 0000 (сокращенной записью  - 0)
