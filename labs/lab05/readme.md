...
Странная история, но у меня не получается подключиться по заданному имени, но по IP получается и все работает. Перезапуск CPT не помог<br>
...
После этого, так же как на маршрутизаторе по имени подключиться не удалось. а вот по IP получилось.
