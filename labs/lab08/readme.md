...
IP 192.168.1.0 в двоичной системе будет 11000000.10101000.00000001.00000000<br>
Маска 255.255.255.192 в двочиной системе будет 11111111.11111111.11111111.11000000<br>
...
|AND:|--------| |--------| |--------| |--------|
|Сеть:|11000000|.|10101000|.|00000001|.|00000000|

Результат 11000000.10101000.00000001.00000000 при переводе из двоичной системы в десятичную станет 192.168.1.0
...
Результат 11000000.10101000.00000001.00000000 при переводе из двоичной системы в десятичную станет 192.168.1.0
**Второй IP** подсети 192.168.1.0 + 2 = **192.168.1.2**<br>
**Шлюз по умолчанию**, как правило, первый хостовый адрес подсети, значит будет **192.168.1.1**<br>
...
IP 192.168.1.0 в двоичной системе будет 11000000.10101000.00000001.00000000<br>
Маска 255.255.255.192 в двочиной системе будет 11111111.11111111.11111111.11110000<br>
Сравниваем через AND<br>
