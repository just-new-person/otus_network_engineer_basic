...
Прочие устройства подключены к S2 через порт Fa0/1.
Ранее в Шаг 4 пункт а мы выяснили, что МАС-адрес 00e0.8f2b.d1b3 принадлежит S2 (192.168.1.12)
...
C:\>arp -a
  ...
  192.168.1.12          00e0.8f2b.d1b3        dynamic
```
Значит PC-A (192.168.1.1) имеет МАС-адрес 0004.9AE9.C3AD,
