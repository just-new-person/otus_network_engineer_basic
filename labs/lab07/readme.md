...
3. Наименьший Port ID — при совпадении первых двух параметров решающим становится идентификатор порта (приоритет + номер порта). Получается у него самый "дорогой" путь к руту.***
