...
Какой порт отображается в качестве альтернативного и в настоящее время заблокирован? **На коммутаторе S2 в качетсве альтентивного порта (Altn) выступает порт F0/4**<br>
