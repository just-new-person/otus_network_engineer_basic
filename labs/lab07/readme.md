...
Если у коммутаторов приоритеты (Priority) одинаковые (у меня 32769), то протокол STP смотрит на MAC-адреса (Address). Тот коммутатор, чей MAC-адрес численно меньше (произведенный первым), станет корнем.<br>
...
Какие порты на коммутаторе являются корневыми портами? ___________________________________<br>
Какие порты на коммутаторе являются назначенными портами? ________________________________<br>
Какой порт отображается в качестве альтернативного и в настоящее время заблокирован? ____________________________<br>
